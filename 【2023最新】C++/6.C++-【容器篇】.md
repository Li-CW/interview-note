...
![](image/202205220035143.png)
 二级配置器
![](image/202205220035104.png)
...
~~~
## 10 STL中unordered_map(hash_map)和map的区别，hash_map如何解决冲突以及扩容
...
## 11 vector越界访问下标，map越界访问下标？vector删除元素时会不会释放空间？
